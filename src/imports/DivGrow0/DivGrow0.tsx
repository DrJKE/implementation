import svgPaths from "./svg-vkyliyecv9";
...
function DivWFull() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative w-[256px]" data-name="div.w-full">
      <div className="flex flex-row justify-center overflow-clip rounded-[inherit] size-full">
...
export default function DivGrow() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative size-full" data-name="div.grow-0">
      <DivWFull />
    </div>
  );
}